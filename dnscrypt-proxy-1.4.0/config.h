...
#define LT_DLSEARCH_PATH "/lib:/usr/lib:/opt/vc/lib:/lib/arm-linux-gnueabihf:/usr/lib/arm-linux-gnueabihf:/usr/local/lib"
...
#define PACKAGE_STRING "dnscrypt-proxy 1.4.0"
